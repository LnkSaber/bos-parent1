...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		$('#customerWindow').window('open');
                ...
                //发送ajax请求，请求定区 action  在定区action中通过crm代理对象完成对应crm服务远程调用获得客户对象数
                ...
                //发送ajax请求，请求定区 action  在定区action中通过crm代理对象完成对应crm服务远程调用获得客户对象数
                $.get(url_2,{"id":decidedzoneId},function(data){
                    //遍历json数组
                    for(var i = 0 ; i <data.length ; i++){
                        var id = data[i].id;
                        var name = data[i].name;
                ...
                /**
                 update t_customer set decidedzone_id = null where decidedzone_id = 'asdfasdffasdj' ;

                 update t_customer set decidedzone_id = ? where id = 2;
                 */
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
        ...
        <form id="addDecidedzoneForm" action="decidedzoneAction_add.action" method="get">
	...
	<div class="easyui-window" title="关联客户窗口" id="customerWindow" collapsible="false" closed="true" minimizable="false" maximizable="false" style="top:20px;left:200px;width: 400px;height: 300px;">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="customerForm" action="decidedzoneAction_assigncustomerstodecidedzone.action" method="get">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
                        ...
                        <script type="text/javascript">
                            $(function(){
                                ...
                                $("#associationBtn").click(function(){
                                    ...
                                    //提交表单之前，需要将右侧下拉框所有的选中,为option添加一个selected属性
