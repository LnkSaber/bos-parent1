...
<script type="text/javascript">
	...
	function doImport(){
        ...
        function doShowHighcharts(){
            ...
            //最终返回的数据：名称 ，统计数
            $.get('subareaAction_findSubareasGroupByProvince.action',function(data){
	...
	$(function(){
		...
		$('#searchWindow').window({
            ...
            //定义一个工具方法，用于将指定的from表单所有输入项转为json数据（key：value）
		...
		$("#btn").click(function(){
                ...
                //将指定的from表单所有输入项转为json数据
                var p = $("#searchForm").serializeJson();

                console.log(p);
                //调用数据表格的load方法，重新发送一个ajax请求，并且提交参数
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="height:31px;overflow:hidden;" split="false" border="false" >
            ...
            <script type="text/javascript">
                $(function(){
                    $("#save").click(function(){
                        //表单检验
                        var r = $("#addSubereaForm").form("validate");
                        if(r){
                            $("#addSubereaForm").submit();
                        }
                    });
                });
        ...
        <form id="addSubereaForm" action="subareaAction_add.action" method="get" >
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
                               data-options="url:'regionAction_listAjax.action',
							valueField:'id',textField:'name',mode:'remote',method:'get'" />
						</td>
					</tr>
					<tr>
						<td>关键字</td>
...
<div class="easyui-window" title="显示区域分区分布图" id="showHighcharts" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    <div id="container" style="width:700px; " split="false" border="false" >
    </div>
</div>
