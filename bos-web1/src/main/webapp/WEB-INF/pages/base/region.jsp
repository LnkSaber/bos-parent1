...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
            ...
            //页面加载完毕后，调用OCUpload插件的方法
            $("#button-import").upload({
                action:"regionAction_improxXls.action",
                name:"regionFile"
            });
	...
	<div class="easyui-window" title="区域添加修改" id="addRegionWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form>
                ...
                <td>选择区域</td>
                <td>
                    <input type="text" data-options="url:'regionAction_listAjax.action',
							valueField:'id',textField:'name'" name="province" class="easyui-combobox" required="true"/>
                </td>
					</tr>
					<tr>
						<td>市</td>
