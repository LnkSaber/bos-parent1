...
<script type="text/javascript"
	src="/Bos/js/jquery-1.8.3.js"></script>
<!-- 导入easyui类库 -->
<link id="easyuiTheme" rel="stylesheet" type="text/css"
	href="/Bos/js/easyui/themes/default/easyui.css">
<link rel="stylesheet" type="text/css"
	href="/Bos/js/easyui/themes/icon.css">
<link rel="stylesheet" type="text/css"
	href="/Bos/css/default.css">
<script type="text/javascript"
	src="/Bos/js/easyui/jquery.easyui.min.js"></script>
<!-- 导入ztree类库 -->
<link rel="stylesheet"
	href="/Bos/js/ztree/zTreeStyle.css"
	type="text/css" />
<script
	src="/Bos/js/ztree/jquery.ztree.all-3.5.js"
	type="text/javascript"></script>
<script
	src="/Bos/js/easyui/locale/easyui-lang-zh_CN.js"
	type="text/javascript"></script>
<script type="text/javascript">
	// 初始化ztree菜单
	$(function() {
	...
	function logoutFun() {
		...
		.confirm('系统提示','您确定要退出本次登录吗?',function(isConfirm) {
			//alert(isConfirm);
			if (isConfirm) {
				location.href = 'userAction_logout';
			}
		});
	}
	// 修改密码
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							潭州课堂 | Powered by <a href="http://www.tanzhoujiaoyu.com/">tanzhoujiaoyu.com</a>
						</div>
					</td>
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false"  style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass"  class="easyui-validatebox" data-options="validType:'length[4,12]'" type="Password" class="txt01" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass"  class="easyui-validatebox" data-options="validType:'length[4,12]'" type="Password" class="txt01" /></td>
                    </tr>
                </table>
               	</form>
            </div>
                ...
                <script type="text/javascript">
                	...
                	$("#btnEp").click(function(){
                		...
                		if(txtNewPass == txtRePass){
                			//进行校验
                			$.get("userAction_editPassword.action", {"password": txtNewPass },
              					  function(data){
									alert(data);
                					if(data == "1"){
              					    		//修改成功，关闭修改密码窗口
