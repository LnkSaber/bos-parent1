        ...
        <div region="center" border="false"  style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="editPasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass"  class="easyui-validatebox" data-options="validType:'length[4,8]'" type="Password" class="txt01" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass"  class="easyui-validatebox" data-options="validType:'length[4,8]'" type="Password" class="txt01" /></td>
                    </tr>
                </table>
            </form>
        </div>
            ...
            <script type="text/javascript">
                ...
                $("#btnEp").click(function(){
                    ...
                    if(txtNewPass == txtRePass){
                        //进行校验
                        $.post("userAction_editPassword.action", {"password": txtNewPass },
                            function(data){
                                alert(data);
                                if(data == "1"){
                                    //修改成功，关闭修改密码窗口
