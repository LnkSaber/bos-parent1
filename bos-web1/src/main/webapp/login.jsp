...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="get" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<%--<input style="width:100px; height:35px; border:0; " type="submit" value="登录" />--%>
						</div>
						<a href="userAction_login.action" id="loginform:j_id19" name="loginform:j_id19">
						<span
							id="loginform:loginBtn" class="btn btn-login"
							style="margin-top:-36px;"><input style="width:100px; height:35px; border:0; " type="submit" value="登录" /></span>
						</a>
					</div>
					<div style="color:red; margin:10px auto; width:200px;"><s:actionerror/></div>
				</form>
			</div>
		</div>
	</div>
